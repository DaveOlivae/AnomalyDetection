...
EXPERIMENT_NAME = "20260603_experimento_teste"
...
def save_experiment_config(feature_names: list[str]) -> Path:
    ...
    return save_json(payload, RESULTS_DIR / "experiment_config.json")
...
def main() -> None:
    ...
    if failures:
        failures_path = save_json(failures, RESULTS_DIR / "failures.json")
